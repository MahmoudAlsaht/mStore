...
export default function SectionsTable({ data }: { data: Partial<Section>[] }) {
  ...
  const columns: ColumnDef<Partial<Section>>[] = [
    ...
    {
      accessorKey: "type",
      header: () => <div className="text-right">نوع القسم</div>,
      cell: ({ row }) => (
        <div className="capitalize">
          {row.getValue("type") === "categories" ? "فئات" : "علامات تجارية"}
        </div>
      ),
    },
    {
      accessorKey: "cover",
      header: () => <div className="text-right">صورة القسم</div>,
      cell: ({ row }) => (
        <Image
    ...
    },
    {
      ...
      header: () => <div className="text-right">اللافتة</div>,
      cell: ({ row }) =>
                ...
                <Button
                  ...
                  onClick={() => {
                    startTransition(async () => {
                      await deleteSection(section.id as string);
                      router.refresh();
                    });
                  }}
                >
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4">
        ...
        <LoadingLink href="/admin/settings/sections/new">
