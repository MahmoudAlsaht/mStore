...
export default function SectionCard({
  ...
  return (
    <div className="cursor-pointer rounded-3xl shadow-md duration-500 sm:w-full sm:hover:scale-105 sm:hover:shadow-xl">
      <LoadingLink href={`/sections/${section.type}/${section.id}`}>
        <div className="relative h-24 sm:h-44">
          ...
          />
          <span className="text-mStorePrimary-dark absolute bottom-0 flex h-1/3 w-full flex-col justify-center rounded-md rounded-bl-3xl rounded-br-3xl bg-slate-200/85 p-1 py-0 text-center text-xs font-semibold">
            {section.name}
          </span>
        </div>
      </LoadingLink>
